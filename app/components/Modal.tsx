        ...
        <>
            {modal &&
                <dialog
                    ...
                    <div className="h-full sm:h-auto bg-black border-off-white rounded-lg flex flex-col items-center relative py-4">
                        <Link href={pathname} className="text-left absolute right-3 top-3">
