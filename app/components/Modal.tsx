        ...
        <>
            {modal &&
                <dialog
                    ...
                    <div className="h-full bg-black border-off-white rounded-lg flex flex-col items-center relative">
                        <Link href={pathname} className="text-left w-8 absolute right-3 top-0">
